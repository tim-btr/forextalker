...
if ( ! function_exists( 'newsphere_post_thumbnail' ) ) :
    ...
    function newsphere_post_thumbnail() {
        ...
        if ( is_singular() ) :
            ...
            if ( $post_class != 'no-image' ):
                ...
                <div <?php echo esc_attr($post_class); ?>">
                    <?php the_post_thumbnail('newsphere-featured', ['itemprop' => 'image']); ?>
                </div>
            <?php endif; ?>
        ...
        <?php else :
            ...
            ?>
            <div itemprop="logo" itemscope itemtype="https://schema.org/ImageObject" class="post-thumbnail class="post-thumbnail <?php echo esc_attr($archive_class); ?>">
