        ...
        <div class="container-wrapper">
            <div class="af-container-row">
                <div class="col-1 color-pad">
                    <?php 
                    //$newsphere_copy_right = newsphere_get_option('footer_copyright_text');
                    ?>
                    <?php 
                    //if (!empty($newsphere_copy_right)): 
                    //    echo esc_html($newsphere_copy_right); 
                    //endif;
                    ?>
                    2019 - <?php echo date('Y'); ?> Copyright © All rights reserved.
                </div>
            </div>
        </div>
    </div>
